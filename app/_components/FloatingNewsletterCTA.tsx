...
export function FloatingNewsletterCTA() {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 bg-card border border-border p-4 rounded-lg shadow-lg md:max-w-sm z-50 backdrop-blur-sm sm:left-auto sm:right-4">
